...
const manuscripts: Manuscript[] = [
  {
    ...
    targetBundle: 'MPBundle:www-zotero-org-styles-apa-5th-edition',
...

  {
    ...
    createdAt: Math.floor(new Date('2018-01-22T08:00:00Z').getTime() / 1000),
    updatedAt: Math.floor(new Date('2018-01-22T08:00:00Z').getTime() / 1000),
    targetBundle: 'MPBundle:www-zotero-org-styles-nature',
...

  {
    ...
    createdAt: Math.floor(new Date('2018-01-22T08:00:00Z').getTime() / 1000),
    updatedAt: Math.floor(new Date('2018-01-22T08:00:00Z').getTime() / 1000),
    targetBundle: 'MPBundle:www-zotero-org-styles-peerj',
