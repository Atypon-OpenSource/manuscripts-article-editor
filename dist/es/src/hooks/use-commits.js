...
const useCommits = ({ sortBy, editor }) => {
    ...
    const freeze = (asAccepted) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (changeSummary.deletion.length === 0 &&
            ...
            changeType = (_a = track_changes_1.commitToJSON(commit, store.projectID).steps[0].slice) === null || _a === void 0 ? void 0 : _a.content[0].type;
    ...
    const hasCommitNewSection = (commit) => commit.steps.length &&
        commit.steps.some((step) => step instanceof prosemirror_transform_1.ReplaceAroundStep);
