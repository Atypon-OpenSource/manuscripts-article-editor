...
class ModelManager {
    constructor(modelMap, setModelsState, manuscriptID, projectID, collection, userCollection, snapshots, commits, db) {
        ...
        this.createProjectLibraryCollection = (libraryCollection, projectID) => __awaiter(this, void 0, void 0, function* () {
            yield this.collection.create(libraryCollection, {
        ...
        this.saveBiblioItem = (item, projectID) => __awaiter(this, void 0, void 0, function* () {
            return yield this.collection.create(item, {
                containerID: projectID,
            });
        });
        this.updateBiblioItem = (item) => {
            return this.collection.update(item._id, item);
        };
        this.deleteBiblioItem = (item) => {
