                ...
                switch (label) {
                    case 'Content': {
                        return (react_1.default.createElement(Inspector_1.InspectorTabPanel, { key: label },
                            ...
                            config_1.default.export.literatum && selected && (react_1.default.createElement(NodeInspector_1.NodeInspector, { selected: selected, state: view.state, dispatch: view.dispatch })),
