...
const ContentTab = ({ selected, selectedSection, selectedElement, dispatch, hasFocus, state, }) => {
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(StatisticsInspector_1.StatisticsInspector, { manuscriptNode: doc, sectionNode: selectedSection ? selectedSection.node : undefined }),
        config_1.default.export.literatum && react_1.default.createElement(HeaderImageInspector_1.HeaderImageInspector, null),
        config_1.default.export.literatum && selected && (react_1.default.createElement(NodeInspector_1.NodeInspector, { selected: selected, state: state, dispatch: dispatch })),
        react_1.default.createElement(ManuscriptInspector_1.ManuscriptInspector, { key: manuscript._id, state: state, dispatch: dispatch, getTemplate: getTemplate, getManuscriptCountRequirements: getManuscriptCountRequirements }),
        (element || section) && config_1.default.features.projectManagement && (react_1.default.createElement(ManageTargetInspector_1.ManageTargetInspector, { target: !hasFocus
                ? manuscript
                : (element || section) })),
        section && (react_1.default.createElement(SectionInspector_1.SectionInspector, { key: section._id, section: section, sectionNode: selectedSection ? selectedSection.node : undefined, state: state, dispatch: dispatch, dispatchNodeAttrs: dispatchNodeAttrs, getSectionCountRequirements: getSectionCountRequirements }))));
};
