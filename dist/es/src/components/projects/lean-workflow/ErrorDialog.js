...
const ErrorDialog = ({ isOpen, header, message, handleOk }) => {
    return (react_1.default.createElement(style_guide_1.Dialog, { isOpen: isOpen, category: style_guide_1.Category.error, header: header, message: message, actions: {
            primary: {
                action: handleOk,
                title: 'OK',
            },
