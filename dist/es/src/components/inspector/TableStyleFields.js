...
exports.CaptionAlignmentField = exports.CaptionPositionField = void 0;
...
const CaptionPositionField = ({ value, handleChange }) => (react_1.default.createElement(ManuscriptStyleInspector_1.InspectorField, null,
    ...
    react_1.default.createElement(inputs_1.StyleSelect, { value: value, onChange: (event) => {
        ...
        } }, Object.entries(styles_1.tableCaptionPositions).map(([key, value]) => (react_1.default.createElement("option", { value: key, key: key }, value.label))))));
...
//# sourceMappingURL=TableStyleFields.js.map