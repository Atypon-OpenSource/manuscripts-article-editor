...
exports.ModalForm = exports.ModalFormActions = void 0;
...
exports.ModalFormActions = styled_components_1.default.div `
  margin-top: ${(props) => props.theme.grid.unit * 4}px;
  display: flex;
  justify-content: flex-end;
`;
const ModalForm = ({ children, handleClose, title, }) => (react_1.default.createElement(style_guide_1.SimpleModal, { handleClose: handleClose, width: '480px', closeWithOverlay: false },
