...
const HistoryPanelContainer = styled_components_1.default.div `
  ...
  overflow-y: auto;
`;
const HistoricalView = ({ project, match, history: browserHistory, user, }) => {
    ...
    const selectedManuscript = currentSnapshot.manuscripts.find((manuscript) => match.params.manuscriptID === manuscript._id);
    if (!selectedManuscript) {
        return null;
    }
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(HistorySidebar_1.HistorySidebar, { project: project, manuscript: selectedManuscript, doc: currentSnapshot.doc }),
                ...
                react_1.default.createElement(EditorContainer_1.EditorContainerInner, null,
                    react_1.default.createElement(HistoryEditorBody, null,
                        react_1.default.createElement(BackLinkWrapper, null,
                            react_1.default.createElement(BackLink, { to: `/projects/${project._id}/manuscripts/${selectedManuscript._id}` },
                        ...
                        react_1.default.createElement(HistoryMetadata_1.HistoryMetadata, { manuscript: selectedManuscript, modelMap: currentSnapshot.modelMap }),
                        react_1.default.createElement(HistoricalManuscriptView_1.HistoricalManuscriptView, { project: project, browserHistory: browserHistory, manuscript: selectedManuscript, currentSnapshot: currentSnapshot, user: user }))))),
        react_1.default.createElement(Panel_1.default, { name: "history", minSize: 300, direction: "row", side: "start", hideWhen: "max-width: 900px", resizerButton: ResizerButtons_1.ResizingInspectorButton },
            react_1.default.createElement(Inspector_1.InspectorContainer, null,
                react_1.default.createElement(HistoryPanelContainer, null,
                    react_1.default.createElement(History_1.HistoryPanel, { project: project, manuscriptID: match.params.manuscriptID, snapshotsList: snapshotsList, currentUserId: "" }))))));
};
