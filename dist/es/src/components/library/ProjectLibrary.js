...
exports.ProjectLibrary = react_1.default.memo(({ match: { params: { projectID, filterID }, }, projectLibraryCollections, projectLibraryCollectionsCollection, projectLibrary, projectLibraryCollection, user, query, setQuery, selectedItem, setSelectedItem, }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(Panel_1.default, { name: 'libraryItem', side: 'start', direction: 'row', minSize: 300, resizerButton: ResizerButtons_1.ResizingInspectorButton }, selectedItem && (react_1.default.createElement(LibraryForm_1.default, { key: selectedItem._id, item: selectedItem, handleSave: handleSave, handleDelete: handleDelete, projectID: projectID, projectLibraryCollections: projectLibraryCollections, projectLibraryCollectionsCollection: projectLibraryCollectionsCollection, user: user })))));
});
