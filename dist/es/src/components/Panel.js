...
class Panel extends react_1.default.Component {
    ...
    render() {
        ...
        const resizer = hidden ? null : (react_1.default.createElement(style_guide_1.Resizer, { collapsed: collapsed, direction: direction, side: side, onResize: this.handleResize, onResizeEnd: this.handleResizeEnd, onResizeButton: this.handleResizeButton, buttonInner: resizerButton }));
