...
const Main = ({ submissionId, manuscriptID, projectID }) => (react_1.default.createElement(react_dnd_1.DndProvider, { backend: react_dnd_html5_backend_1.HTML5Backend },
    ...
    react_1.default.createElement(ModalHookableProvider_1.ModalProvider, null,
        react_1.default.createElement(react_hooks_1.ApolloProvider, { client: apollo_1.apolloClient },
            react_1.default.createElement(EditorApp_1.default, { submissionId: submissionId, manuscriptID: manuscriptID, projectID: projectID })))));
