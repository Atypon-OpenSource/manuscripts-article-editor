...
import { BibliographyItem, CommentAnnotation, ContainerInvitation, Library, LibraryCollection, Manuscript, ManuscriptNote, ManuscriptTemplate, Model, Project, ProjectInvitation, Snapshot, Tag, UserProfile } from '@manuscripts/manuscripts-json-schema';
...
export declare type state = {
    ...
    biblio: BiblioTools;
    createProjectLibraryCollection: (collection: Build<LibraryCollection>, projectID: string) => Promise<void>;
    saveBiblioItem: (item: Build<BibliographyItem>, projectID: string) => Promise<BibliographyItem>;
