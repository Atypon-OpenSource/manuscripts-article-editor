...
export declare type stateSetter = (setState: (currentState: state) => state) => void;
...
export declare class BasicSource implements StoreDataSourceStrategy {
    ...
    constructor(submissionID: string, fileManagement: FileManagement, projectID: string, manuscriptID: string, submission: Submission, person: Person, userID?: string | undefined, authToken?: string | undefined);
    build: builderFn;
}
