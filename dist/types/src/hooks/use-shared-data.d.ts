 ...
 */
import { ManuscriptCountRequirementType, SectionCountRequirementMaps } from '../lib/requirements';
import { ManuscriptTemplateData } from '../lib/templates';
export declare const useSharedData: () => {
    getTemplate: (templateID: string) => ManuscriptTemplateData | undefined;
    getRequirement: (requirementID: string) => import("../lib/templates").TemplatesDataType | undefined;
