 ...
 */
import { BibliographyItem, Library, LibraryCollection, Project, UserProfile } from '@manuscripts/manuscripts-json-schema';
...
export declare const LibraryPageContainer: React.FC<RouteComponentProps<{
    projectID: string;
