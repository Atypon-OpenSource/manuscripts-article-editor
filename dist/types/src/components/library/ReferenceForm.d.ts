 ...
 */
import { BibliographicName, BibliographyItem } from '@manuscripts/manuscripts-json-schema';
...
export declare const buildInitialValues: (item: BibliographyItem) => ReferenceFormValues;
export declare const bibliographyItemTypeOptions: OptionsType<OptionType>;
declare const ReferenceForm: React.FC<{
