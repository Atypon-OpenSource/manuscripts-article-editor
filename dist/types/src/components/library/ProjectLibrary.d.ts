 ...
 */
import { BibliographyItem, LibraryCollection, UserProfile } from '@manuscripts/manuscripts-json-schema';
import React from 'react';
import { RouteComponentProps } from 'react-router-dom';
import { Collection } from '../../sync/Collection';
export declare const ProjectLibrary: React.FC<RouteComponentProps<{
    projectID: string;
    filterID?: string;
}> & {
