 ...
 */
import { ContainerInvitation, UserProfile } from '@manuscripts/manuscripts-json-schema';
...
declare class AddCollaboratorsSidebar extends React.Component<Props, State> {
    state: {
        searchText: string;
        searchResults: never[];
    };
