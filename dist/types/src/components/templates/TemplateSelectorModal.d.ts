 ...
 */
import { ManuscriptCategory, ResearchField } from '@manuscripts/manuscripts-json-schema';
...
export declare class TemplateSelectorModal extends Component<Props, State> {
    ...
    private hasSelectedCategory;
    private hasSelectedField;
    private resetScroll;
    private resetList;
