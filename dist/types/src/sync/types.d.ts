...
export declare type Direction = 'pull' | 'push';
export declare type ReplicationStatus = 'active' | 'ready' | 'cancelled' | null;
declare type PouchReplicationErrorNames = 'Unauthorized' | 'Bad Request' | 'Not Found' | 'Conflict' | 'Missing Id' | 'Precondition Failed' | 'Unknown Error' | 'Invalid Request' | 'Query Parse Error' | 'Doc Validation' | 'Badarg' | 'Forbidden';
