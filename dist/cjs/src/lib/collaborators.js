...
exports.buildCollaboratorProfiles = exports.buildCollaborators = void 0;
const buildCollaborators = (project, collaborators) => {
    const getCollaborator = (id) => collaborators.get(id);
    return [
...
exports.buildCollaborators = buildCollaborators;
const buildCollaboratorProfiles = (collaborators, user, key = 'userID') => {
    const profiles = new Map();
    for (const collaborator of collaborators.values()) {
        profiles.set(collaborator.collaboratorProfile[key], collaborator.collaboratorProfile);
    }
