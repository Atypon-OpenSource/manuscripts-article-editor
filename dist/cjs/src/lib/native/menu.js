...
exports.createDispatchMenuAction = exports.createGetMenuState = void 0;
const isMenuSeparator = (item) => item.role === 'separator';
...
const createGetMenuState = (view, menus) => (key) => {
...
exports.createGetMenuState = createGetMenuState;
const createDispatchMenuAction = (menus) => (key) => {
...
exports.createDispatchMenuAction = createDispatchMenuAction;
