...
exports.createDispatchManuscriptToolbarAction = exports.manuscriptToolbarState = void 0;
const manuscript_editor_1 = require("@manuscripts/manuscript-editor");
const manuscriptToolbarItems = new Map();
for (const section of Object.values(manuscript_editor_1.toolbar)) {
    for (const [key, item] of Object.entries(section)) {
        manuscriptToolbarItems.set(key, item);
    }
}
const manuscriptToolbarState = (state) => {
    const output = {};
...
exports.manuscriptToolbarState = manuscriptToolbarState;
const createDispatchManuscriptToolbarAction = (view) => (key) => {
...
exports.createDispatchManuscriptToolbarAction = createDispatchManuscriptToolbarAction;
//# sourceMappingURL=manuscript-toolbar.js.map