...
function replaceAttachmentsIds(modelMap, attachments) {
    ...
    modelMap.forEach((model) => {
        var _a;
        const figure = Object.assign({}, model);
...
function replaceAttachmentLinks(modelMap, attachments) {
    ...
    modelMap.forEach((model) => {
        ...
        if (figure.objectType === manuscripts_json_schema_1.ObjectTypes.Figure && figure.src) {
            const attachment = attachments.find((a) => { var _a; return (_a = figure.src) === null || _a === void 0 ? void 0 : _a.startsWith(a.link); });
            if (attachment) {
...
//# sourceMappingURL=replace-attachments-ids.js.map