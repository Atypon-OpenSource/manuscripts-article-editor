...
const AddIconButton = styled_components_1.default(style_guide_1.IconButton).attrs({ defaultColor: true }) `
  width: unset;
  height: unset;
`;
class AddAuthorButton extends react_1.default.Component {
    constructor() {
        ...
        this.handleSelected = () => {
            ...
            createAuthor(authors_1.buildAuthorPriority(authors), person);
        };
    }
    componentDidMount() {
        this.setState({
