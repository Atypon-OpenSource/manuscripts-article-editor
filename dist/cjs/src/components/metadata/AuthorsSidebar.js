...
`;
const AuthorsSidebar = ({ authors, selectAuthor, selectedAuthor, openAddAuthors, handleDrop, getSidebarItemDecorator, invitationSent, handleDismiss, }) => (react_1.default.createElement(Sidebar_1.ModalSidebar, { "data-cy": 'authors-sidebar' },
    ...
    react_1.default.createElement(Sidebar_1.SidebarContent, null,
        ...
        react_1.default.createElement(style_guide_1.AuthorsDND, { authors: authors, selectAuthor: selectAuthor, selectedAuthor: selectedAuthor, handleDrop: handleDrop, getSidebarItemDecorator: getSidebarItemDecorator }))));
