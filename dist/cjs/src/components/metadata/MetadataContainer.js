...
const MetadataContainer = ({ permissions, allowInvitingAuthors, showAuthorEditButton, disableEditButton, handleTitleStateChange, }) => {
    ...
    const updateAuthor = (invitingUser) => (author, invitedEmail) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const updatedAuthor = yield saveModel(Object.assign(Object.assign({}, author), { invitationID: invitation._id }));
    ...
    const createInvitedAuthor = (authors, invitedEmail, invitingID, name) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield createAuthor(authors_1.buildAuthorPriority(authors), null, name, invitation._id);
    });
