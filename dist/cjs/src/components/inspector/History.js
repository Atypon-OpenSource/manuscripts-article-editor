...
`;
const SnapshotComponent = ({ userId, date, children, onSwitchSnapshot, }) => {
    return (react_1.default.createElement(SnapshotComponentContainer, null,
        ...
        react_1.default.createElement(SnapshotComponentContainerInner, null,
            react_1.default.createElement(TitleLine, null,
                ...
                onSwitchSnapshot && (react_1.default.createElement(ViewLink, { to: "#", onClick: (e) => {
                        e.preventDefault();
                        onSwitchSnapshot && onSwitchSnapshot();
                    } }, "View"))),
            children)));
};
const HistoryPanel = ({ project, manuscriptID, snapshotsList, requestTakeSnapshot, isCreateFormOpen = false, submitName, handleTextFieldChange, textFieldValue = '', status, currentUserId, onSwitchSnapshot, }) => {
    return (react_1.default.createElement("div", null,
        ...
        react_1.default.createElement(List, null, snapshotsList.map((item) => (react_1.default.createElement(ListItem, { key: item._id },
            react_1.default.createElement(SnapshotComponent, { date: item.createdAt, userId: item.creator, onSwitchSnapshot: () => onSwitchSnapshot && onSwitchSnapshot(item) },
