...
const FigureLayouts = ({ figureElement, figureLayouts, figureLayout, setElementFigureLayout, setElementAlignment, setElementSizeFraction, }) => {
    return (react_1.default.createElement(InspectorSection_1.InspectorSection, { title: 'Figure Layout' },
        ...
        config_1.default.export.literatum && (react_1.default.createElement(FigureAlignmentField_1.FigureAlignmentField, { defaultValue: styles_1.DEFAULT_FIGURE_ALIGNMENT, value: figureElement.alignment, handleChange: setElementAlignment, disabled: Boolean(figureElement.sizeFraction && figureElement.sizeFraction >= 1) }))));
};
