...
const SectionInspector = ({ dispatchNodeAttrs, section, sectionNode, state, dispatch, getSectionCountRequirements, }) => {
    const [modelMap] = store_1.useStore((store) => store.trackModelMap);
    const [saveModel] = store_1.useStore((store) => store.saveTrackModel);
    ...
    return (react_1.default.createElement(InspectorSection_1.InspectorSection, { title: 'Section' },
        ...
        react_1.default.createElement(Inspector_1.InspectorTabs, null,
            react_1.default.createElement(Inspector_1.InspectorPanelTabList, null,
                config_1.default.features.requirements && react_1.default.createElement(Inspector_1.InspectorTab, null, "General"),
                config_1.default.features.requirements && (react_1.default.createElement(Inspector_1.InspectorTab, null, "Requirements"))),
            react_1.default.createElement(Inspector_1.InspectorTabPanels, null,
                ...
                config_1.default.features.requirements && (react_1.default.createElement(Inspector_1.InspectorTabPanel, null,
