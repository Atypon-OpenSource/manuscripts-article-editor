...
const RequirementsInspector = () => {
    ...
    return (react_1.default.createElement(exports.RequirementsInspectorView, { prototypeId: prototypeId, result: result, error: error }));
};
exports.RequirementsInspector = RequirementsInspector;
const RequirementsInspectorView = ({ error, prototypeId, result }) => {
    if (error) {
