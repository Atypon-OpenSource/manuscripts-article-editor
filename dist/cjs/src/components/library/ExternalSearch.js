...
exports.ExternalSearch = react_1.default.memo(({ debouncedQuery, match: { params: { projectID, sourceID }, }, projectLibrary, projectLibraryCollection, query, setQuery, }) => {
    ...
    const handleAdd = react_1.useCallback((item) => projectLibraryCollection.create(item, {
