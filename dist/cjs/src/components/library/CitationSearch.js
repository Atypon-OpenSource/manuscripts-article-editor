...
const TemplateIcon_1 = require("../projects/lean-workflow/icons/TemplateIcon");
...
`;
const ImportButton = ({ importItems, importing, }) => (react_1.default.createElement(style_guide_1.IconTextButton, { onClick: importItems },
    react_1.default.createElement(style_guide_1.Tip, { title: 'Import bibliography data from a BibTeX or RIS file', placement: 'top' }, importing ? ('Importing…') : (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(style_guide_1.UploadIcon, null),
        "Import from file")))));
const CitationSearch = ({ filterLibraryItems, handleCite, addCitation, importItems: _importItems, query: initialQuery, handleCancel, }) => {
    ...
    return (react_1.default.createElement(Container, null,
        ...
        react_1.default.createElement(Actions, null,
            react_1.default.createElement(AddCitationActions, null,
                ...
                react_1.default.createElement(style_guide_1.IconTextButton, { onClick: addCitation },
                    react_1.default.createElement(TemplateIcon_1.TemplateIcon, null),
                    "Add new")),
...
const AddCitationActions = styled_components_1.default(style_guide_1.ButtonGroup) `
  button {
