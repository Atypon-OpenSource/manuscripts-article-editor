...
class AcceptInvitationURIContainer extends react_1.default.Component {
    constructor() {
        super(...arguments);
        this.state = {};
    }
    componentDidMount() {
        ...
        api_1.acceptProjectInvitationToken(invitationToken)
            .then(({ data }) => {
            this.setState({ data });
        })
            .catch((error) => {
...
exports.default = AcceptInvitationURIContainer;
//# sourceMappingURL=AcceptProjectInvitationURIPageContainer.js.map