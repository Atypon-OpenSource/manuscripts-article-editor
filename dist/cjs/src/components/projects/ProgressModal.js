...
const ModalFooter = styled_components_1.default(style_guide_1.ButtonGroup) `
  padding: ${(props) => props.theme.grid.unit * 4}px;
`;
const ProgressModal = ({ canCancel, handleCancel, status, }) => (react_1.default.createElement(style_guide_1.StyledModal, { isOpen: true, onRequestClose: handleCancel, shouldCloseOnOverlayClick: false },
    react_1.default.createElement(ModalBody, null,
        ...
        react_1.default.createElement(ModalFooter, null,
            react_1.default.createElement(style_guide_1.PrimaryButton, { onClick: handleCancel, disabled: !canCancel }, "Cancel")))));
