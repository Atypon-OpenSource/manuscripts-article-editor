...
const ManuscriptSidebar = ({ openTemplateSelector, state, manuscript, view, project, saveProjectTitle, user, }) => {
    ...
    return (react_1.default.createElement(PageSidebar_1.default, { direction: 'row', hideWhen: 'max-width: 900px', minSize: 260, name: 'sidebar', side: 'end', sidebarTitle: config_1.default.leanWorkflow.enabled ? (react_1.default.createElement(react_1.default.Fragment, null)) : (react_1.default.createElement(Sidebar_1.SidebarHeader, { title: react_1.default.createElement(CustomizedSidebarHeader, null,
                react_1.default.createElement(ProjectTitle, null, saveProjectTitle ? (react_1.default.createElement(title_editor_1.TitleField, { id: 'project-title-field', 
                    ...
                    tabIndex: 1, editable: can.editArticle, value: project.title || '', handleChange: lodash_es_1.debounce(saveProjectTitle, 1000) })) : (react_1.default.createElement(title_editor_1.Title, { id: "project-title", editable: false, value: project.title || '' }))),
                react_1.default.createElement(ShareProjectButton_1.default, { project: project, user: user, tokenActions: tokenActions })) })), sidebarFooter: can.editArticle && openTemplateSelector ? (react_1.default.createElement(AddButton_1.AddButton, { action: () => openTemplateSelector(false), size: 'small', title: 'New Manuscript' })) : (react_1.default.createElement(react_1.default.Fragment, null)) }, sortedManuscripts.map((item, index) => (react_1.default.createElement(SortableManuscript_1.SortableManuscript, { key: item._id, index: index, item: item, setIndex: setIndex }, selected && item._id === manuscript._id ? (react_1.default.createElement(manuscript_editor_1.ManuscriptOutline, { manuscript: manuscript, doc: (state === null || state === void 0 ? void 0 : state.doc) || null, view: view, selected: selected })) : (react_1.default.createElement(manuscript_editor_1.OutlineManuscript, { project: project, manuscript: item })))))));
};
