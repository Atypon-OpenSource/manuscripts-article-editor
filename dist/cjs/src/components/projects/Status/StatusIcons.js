...
exports.calculateCircumference = exports.PlusIcon = exports.DndIcon = exports.ToDoIcon = exports.DoneIcon = exports.DoingIcon = exports.CloseIcon = void 0;
const react_1 = __importDefault(require("react"));
// TODO Delete the icons when they are ready in assets repository
const CloseIcon = () => (react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", height: "16px", viewBox: "0 0 512 512", width: "16px" },
...
const DoingIcon = () => (react_1.default.createElement("svg", { width: "16", height: "16", viewBox: "0 0 16 16", className: "iconDoing" },
    react_1.default.createElement("g", { fill: "none", fillRule: "evenodd" },
        react_1.default.createElement("circle", { cx: "8", cy: "8", r: "4", className: "pie", stroke: "#353535", strokeWidth: "8", strokeDasharray: "12.5", transform: "rotate(-90) translate(-15)" }),
        react_1.default.createElement("circle", { stroke: "#353535", cx: "8", cy: "8", r: "7.5" }))));
exports.DoingIcon = DoingIcon;
const DoneIcon = () => (react_1.default.createElement("svg", { className: "iconDone", width: "16", height: "16", viewBox: "0 0 16 16", xmlns: "http://www.w3.org/2000/svg" },
    react_1.default.createElement("g", { fill: "none", fillRule: "evenodd" },
        react_1.default.createElement("circle", { fill: "#353535", cx: "8", cy: "8", r: "8" }),
        react_1.default.createElement("path", { d: "M4.97 7.54a1.026 1.026 0 00-1.43.032l.174-.176a.972.972 0 00.018 1.396l2.694 2.536 5.807-5.5a.93.93 0 00-.007-1.374l.18.17a1.089 1.089 0 00-1.467-.003l-4.556 4.25L4.97 7.54z", fill: "#FFF" }))));
exports.DoneIcon = DoneIcon;
const ToDoIcon = () => (react_1.default.createElement("svg", { className: "iconToDo", width: "16", height: "16", viewBox: "0 0 16 16", xmlns: "http://www.w3.org/2000/svg" },
    react_1.default.createElement("g", { stroke: "#353535", fill: "none", fillRule: "evenodd" },
        react_1.default.createElement("circle", { cx: "8", cy: "8", r: "7.5" }),
        react_1.default.createElement("circle", { cx: "8", cy: "8", r: "3.056" }))));
exports.ToDoIcon = ToDoIcon;
const DndIcon = () => (react_1.default.createElement("svg", { width: "16", height: "16", viewBox: "0 0 16 16" },
    react_1.default.createElement("defs", null,
        react_1.default.createElement("mask", { id: "b", maskContentUnits: "userSpaceOnUse", maskUnits: "objectBoundingBox", x: "0", y: "0", width: "10", height: "10", fill: "#fff" },
            react_1.default.createElement("rect", { x: "0", y: "0", width: "10", height: "10", rx: "2" }))),
    react_1.default.createElement("g", { fill: "none", fillRule: "evenodd" },
        react_1.default.createElement("rect", { x: "0", y: "0", width: "10", height: "10", rx: "2", stroke: "#6E6E6E", mask: "url(#b)", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", strokeDasharray: "1,3" }),
        react_1.default.createElement("path", { d: "M6 8a2 2 0 012-2h6a2 2 0 012 2v6a2 2 0 01-2 2H8a2 2 0 01-2-2V8zm1 0v6a1 1 0 001 1h6a1 1 0 001-1V8a1 1 0 00-1-1H8a1 1 0 00-1 1z", fill: "#6E6E6E" }),
        react_1.default.createElement("path", { d: "M8.405 4.605a1.015 1.015 0 011.434 0l1.144 1.436c.552.552.706 1.458.706 2.239 0 .78-.304 1.515-.856 2.066-1.249 1.008-2.092 1.511-2.53 1.511H7.33c-1.11 0-2.013-.287-2.013-1.397V9.66l-.713-.714A1.015 1.015 0 015.15 7.23a1.016 1.016 0 011.29-1.476 1.015 1.015 0 011.687-.624 1.01 1.01 0 01.278-.524z", fill: "#FFF", fillRule: "nonzero" }),
        react_1.default.createElement("path", { d: "M8.405 4.605a1.015 1.015 0 011.434 0h0l1.144 1.436c.552.552.706 1.458.706 2.239 0 .78-.304 1.515-.856 2.066-1.249 1.008-2.092 1.511-2.53 1.511h0-.973c-1.11 0-2.013-.287-2.013-1.397h0V9.66l-.713-.714A1.015 1.015 0 015.15 7.23a1.016 1.016 0 011.29-1.476 1.015 1.015 0 011.687-.624 1.01 1.01 0 01.278-.524zm1.119.316a.58.58 0 00-.802 0c-.221.22-.221.58 0 .801h0l.108.108a.223.223 0 010 .317.224.224 0 01-.316 0h0l-.667-.667a.568.568 0 00-.802.801h0l.666.667a.223.223 0 010 .317.224.224 0 01-.316 0h0L6.393 6.262a.568.568 0 00-.802.802h0l1.002 1.002a.223.223 0 010 .317.224.224 0 01-.316 0h0l-.555-.555a.58.58 0 00-.802 0 .564.564 0 000 .801h0l1.673 1.673a.223.223 0 010 .317.224.224 0 01-.316 0h0l-.512-.513v.354c0 .864.702.95 1.565.95h.973c.358 0 1.096-.46 2.214-1.38a2.46 2.46 0 00.725-1.75c0-.661-.107-1.455-.574-1.922h0z", stroke: "#6E6E6E", strokeWidth: ".5", fill: "#353535", fillRule: "nonzero" }))));
exports.DndIcon = DndIcon;
...
const calculateCircumference = (id, list) => {
...
const RenderIcon = (id, list) => {
    const { circumference, percent } = exports.calculateCircumference(id, list);
    switch (percent) {
        case 0: // first item
            return react_1.default.createElement(exports.ToDoIcon, null);
        case circumference: // last item
            return react_1.default.createElement(exports.DoneIcon, null);
        default:
            return react_1.default.createElement(exports.DoingIcon, null);
    }
};
