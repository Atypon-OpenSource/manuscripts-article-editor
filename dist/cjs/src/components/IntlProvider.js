...
exports.withIntl = exports.IntlContext = void 0;
...
exports.IntlContext = react_1.default.createContext({});
const withIntl = (Component) => (props) => (react_1.default.createElement(exports.IntlContext.Consumer, null, (value) => react_1.default.createElement(Component, Object.assign({}, props, { intl: value }))));
exports.withIntl = withIntl;
// eslint-disable-next-line @typescript-eslint/ban-types
class IntlProvider extends react_1.default.Component {
    constructor() {
        super(...arguments);
        this.state = {
            locale: 'en',
    ...
    render() {
        ...
        const value = Object.assign(Object.assign({}, this.state), { setLocale: this.setLocale });
        return (react_1.default.createElement(Intl.IntlProvider, { locale: locale, key: locale, messages: messages },
            react_1.default.createElement(exports.IntlContext.Provider, { value: value }, this.props.children)));
    }
}
