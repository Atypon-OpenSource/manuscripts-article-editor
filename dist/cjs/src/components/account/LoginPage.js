...
const LoginPage = ({ initialValues, validationSchema, onSubmit, submitErrorType, }) => (react_1.default.createElement(Page_1.Centered, null,
    react_1.default.createElement(formik_1.Formik, { initialValues: initialValues, validationSchema: validationSchema, isInitialValid: true, validateOnChange: false, validateOnBlur: false, onSubmit: onSubmit }, (formikProps) => (react_1.default.createElement(LoginForm_1.LoginForm, Object.assign({}, formikProps, { submitErrorType: submitErrorType })))),
    react_1.default.createElement(Authentication_1.AuthenticationContainer, null,
        react_1.default.createElement("div", null, "Sign in with"),
