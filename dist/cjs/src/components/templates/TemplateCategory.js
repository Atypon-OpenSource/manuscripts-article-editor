...
`;
class TemplateCategory extends react_1.default.Component {
    constructor() {
        super(...arguments);
        this.categoryRef = react_1.default.createRef();
    }
    componentDidUpdate() {
    ...
    render() {
        return react_1.default.createElement(Category, { ref: this.categoryRef }, this.props.children);
    }
}
