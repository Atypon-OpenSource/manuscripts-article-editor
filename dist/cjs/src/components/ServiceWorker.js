...
exports.createUpdateReadyNotification = exports.ServiceWorker = void 0;
...
const ServiceWorker = ({ children }) => {
    if (config_1.default.serviceworker && 'serviceWorker' in navigator) {
        // eslint-disable-next-line react-hooks/rules-of-hooks
        const { showNotification } = react_1.useContext(NotificationProvider_1.NotificationContext);
        const wb = new workbox_window_1.Workbox('/service-worker.js');
        ...
        wb.addEventListener('waiting', () => {
            const id = 'sw-active';
            showNotification(id, exports.createUpdateReadyNotification({
                id,
                handleAccept: () => {
...
const createUpdateReadyNotification = ({ handleAccept, id, }) => (props) => (react_1.default.createElement(Notifications_1.NotificationPrompt, null,
    react_1.default.createElement(Notifications_1.NotificationHead, null,
        ...
        react_1.default.createElement(Notifications_1.NotificationMessage, null,
            react_1.default.createElement(Notifications_1.NotificationTitle, null, "A new version of the app is available on refreshing."),
            react_1.default.createElement(Notifications_1.NotificationLink, { href: `${config_1.default.discourse.host}/c/updates` }, "What's new?"))),
    react_1.default.createElement(Notifications_1.NotificationActions, null,
        ...
        react_1.default.createElement(style_guide_1.PrimaryButton, { onClick: handleAccept }, "Refresh"))));
exports.createUpdateReadyNotification = createUpdateReadyNotification;
