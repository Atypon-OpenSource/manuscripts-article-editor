...
const OfflineIndicator = ({ children }) => {
    ...
    return (react_1.default.createElement(Wrapper, null,
        onlineState === use_online_state_1.OnlineState.Online ? null : (react_1.default.createElement(style_guide_1.Tip, { placement: 'right-end', title: 'Working offline' },
            react_1.default.createElement(Bubble, null))),
        children));
};
