...
const useComments = (comments, userProfile, editorState, doCommand) => {
    ...
    react_1.useEffect(() => {
        comments.forEach((comment) => {
            ...
            saveComment(Object.assign(Object.assign({}, comment), { target: uuid_1.v4(), selector: { from, to } }))
                .then((comment) => {
                const maybeInsert = manuscript_editor_1.insertAnnotationFromComment(comment);
                if (!maybeInsert) {
                    return;
                }
