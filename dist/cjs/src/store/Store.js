...
class GenericStore {
    constructor(reducer = defaultReducer, unmountHandler, state = {}) {
        ...
        this.init = (sources) => __awaiter(this, void 0, void 0, function* () {
            ...
            const state = yield _1.buildStateFromSources(...sources);
            ...
            this.beforeAction = (...args) => {
                this.sources.map((source) => source.beforeAction && source.beforeAction(...args));
            };
            this.sources.map((source) => source.updateStore && source.updateStore(this.setState));
