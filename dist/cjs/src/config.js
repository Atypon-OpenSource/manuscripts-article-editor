...
const index = config_helpers_1.splitArray(process.env.BASE_URL).findIndex((url) => url.includes(window.location.hostname));
const config = {
    url: config_helpers_1.normalizeURL(config_helpers_1.getURL(process.env.BASE_URL, index)),
    ...
    api: {
        url: config_helpers_1.normalizeURL(config_helpers_1.getURL(process.env.API_BASE_URL, index)),
        headers: {
    ...
    gateway: {
        url: config_helpers_1.normalizeURL(config_helpers_1.getURL(process.env.SYNC_GATEWAY_URL, index)),
    },
    pressroom: {
    ...
    leanWorkflow: {
        ...
        url: config_helpers_1.normalizeURL(config_helpers_1.getURL(process.env.LEAN_WORKFLOW_MANAGER_URL, index)),
        graphqlEndpoint: process.env.LEAN_WORKFLOW_GRAPHQL_ENDPOINT,
        dashboardUrl: config_helpers_1.normalizeURL(config_helpers_1.getURL(process.env.DASHBOARD_URL, index)),
    },
    iam: {
