...
react_1.storiesOf('Citation', module)
    .add('Citation Editor', () => (react_2.default.createElement(CitationEditor_1.default, { filterLibraryItems: () => __awaiter(void 0, void 0, void 0, function* () { return []; }), setLibraryItem: () => addon_actions_1.action('set library item'), removeLibraryItem: () => addon_actions_1.action('remove library item'), modelMap: new Map(), saveModel: addon_actions_1.action('save model'), deleteModel: addon_actions_1.action('delete model'), handleCancel: addon_actions_1.action('handle cancel'), handleCite: addon_actions_1.action('handle cite'), handleClose: addon_actions_1.action('handle close'), handleRemove: addon_actions_1.action('handle remove'), items: items, projectID: 'MPProject:1', scheduleUpdate: addon_actions_1.action('schedule update'), selectedText: 'foo', setCommentTarget: addon_actions_1.action('set comment target'), importItems: addon_actions_1.action('import items'), citation: citation, updateCitation: addon_actions_1.action('update citation'), updatePopper: addon_actions_1.action('update popper') })))
