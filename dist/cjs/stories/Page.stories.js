...
react_1.storiesOf('Page', module)
    .add('A page', () => (react_2.default.createElement(Page_1.Page, null,
    react_2.default.createElement(Page_1.Main, { style: { padding: '10px 20px' } }, "This is the main content"))))
    .add('A page with a project', () => (react_2.default.createElement(Page_1.Page, { project: projects_1.project },
    react_2.default.createElement(Page_1.Main, { style: { padding: '10px 20px' } }, "This is the main content"))));
