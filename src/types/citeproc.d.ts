// from https://github.com/dsifford/academic-bloggers-toolkit/blob/master/lib/types/citeproc.d.ts
...
declare namespace Citeproc {
  ...
  interface Processor {
     ...
     */
    makeBibliography(bibsection?: string): Bibliography | boolean
    /**
    ...
    /**
     * Appends a citation to the registry and regenerates the document's citations.
     * @param citation The new citation to be added
     */
    appendCitationCluster(citation: Citation): CitationResult[]
    /**
  ...
  interface EngineConstructor {
    ...
    getLocaleNames: (style: string, locale: string) => string[]
  }
}
