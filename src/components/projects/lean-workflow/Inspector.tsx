...
const Inspector: React.FC<Props> = ({ tabs, editor }) => {
   ...
   * As result of that we need to get:
   * * inline files represent elements we always have in the editor body we get them form quarterback document.
   * * supplementary files are stored in DB of api.
   */
