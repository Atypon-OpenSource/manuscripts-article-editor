...
import { EditorHeaderGroup } from './EditorHeaderGroup'

const ManuscriptPageContainer: React.FC = () => {
  // Enable global keyboard shortcuts
  useGlobalKeyboardShortcuts()

  const [{ WMsPermittedActions, manuscriptPermittedActions, isViewingMode }] =
    useStore((state) => {
      return {
        project: state.project,
        user: state.user,
        WMsPermittedActions: state.WMsPermittedActions,
        manuscriptPermittedActions: state.manuscriptPermittedActions,
...
const ManuscriptPageView: React.FC = () => {
  ...
  const [isTrackingChangesVisible] = useTrackingVisibility()
