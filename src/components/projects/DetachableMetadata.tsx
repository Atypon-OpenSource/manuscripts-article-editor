...
export const DetachableMetadata: React.FC<{
  subscribe: GenericStore['subscribe']
}> = ({ subscribe }) => {
  const can = usePermissions()

  const [store, setState] = useState<state>()
...
export const createDetachableMetadata = (
  subscribe: GenericStore['subscribe']
) => {
  return <DetachableMetadata subscribe={subscribe} />
}
